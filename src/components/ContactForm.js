...
const ContactForm = () => {
  ...
  return (
    <div className="mt-[156px] xl:px-[360px] lg:px-[180px] md:px-[90px] px-[16px]">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-full">
          ...
          <button
            id="btn__submit"
            className="submit__button mt-[32px] mb-[230px] py-[12px] text-center bg-[#1570EF] border border-[#1570EF] rounded-[8px] w-full text-white"
          >
            Send message
          </button>
        </div>
